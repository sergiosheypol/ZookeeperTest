...
public class ProducerZk implements Watcher{
	...
	public static void main(String[] args) {
		...
		ProducerZk producer = new ProducerZk(nProducts, Integer.parseInt(args[0]));
		producer.produce();
//		producer = new ProducerZk(nProducts, Integer.parseInt(args[0]));
//		producer.produce();
		//producer = new ProducerZk(nProducts, id+2);
		//producer.produce();
